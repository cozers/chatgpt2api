...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    update_repo: typeof config.update_repo === "string" ? config.update_repo : webConfig.defaultUpdateRepo,
    update_github_token: "",
  ...
  saveConfig: async () => {
    ...
    try {
      ...
      const payload: SettingsConfig = {
        ...
        update_repo: String(config.update_repo ?? webConfig.defaultUpdateRepo).trim(),
